      ...
      <div className="max-w-6xl mx-auto space-y-6">
          ...
          <div className="bg-gradient-to-r from-red-500 via-red-600 to-rose-600 rounded-2xl p-8 text-white relative overflow-hidden">
            ...
            <div className="relative flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-red-100 dark:text-red-200 mt-1">Find donors, register to donate, or request blood</p>
              </div>
            </div>
          </div>
        </FadeIn>
              ...
              <button
                ...
                className={`flex items-center gap-2 px-5 py-2.5 rounded-xl text-sm font-medium transition-all duration-300 active:scale-[0.97] ${
                  tab === key
                    ...
                    : 'bg-white dark:bg-gray-800 text-gray-600 dark:text-gray-400 hover:bg-red-50 dark:hover:bg-red-900/20 border border-gray-200 dark:border-gray-700'
                }`}
              >
        ...
        {tab === 'donors' && (
          <div className="space-y-6">
            ...
            {/* Register Form */}
            {showRegister && (
              <form onSubmit={handleRegister} className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 p-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="flex items-end pb-1">
                    <label className="flex items-center gap-3 cursor-pointer">
                      <div className={`relative w-11 h-6 rounded-full transition-colors duration-200 ${dForm.is_available ? 'bg-emerald-500' : 'bg-gray-300 dark:bg-gray-600'}`} onClick={() => setDForm({ ...dForm, is_available: !dForm.is_available })}>
                      ...
                      <span className="text-sm text-gray-700 dark:text-gray-300">Available to donate</span>
                    </label>
                  </div>
                </div>
            ...
            {loading ? (
              <div className="text-center py-12">
                ...
                <p className="text-gray-500 dark:text-gray-400 mt-3 text-sm">Searching donors...</p>
              </div>
            ) : (
              <StaggerChildren staggerDelay={100} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
                {donors.map((d) => (
                  <div key={d.donor_id} className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 p-6 hover:shadow-md hover:-translate-y-1 active:scale-[0.98] transition-all duration-300">
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex-1 min-w-0">
                        <h3 className="font-semibold text-gray-800 dark:text-gray-100 truncate">{d.full_name || d.user_name || 'Donor'}</h3>
                ...
                {donors.length === 0 && (
                  <div className="col-span-full text-center py-12">
                    ...
                    <p className="text-gray-400 dark:text-gray-500 text-sm mt-1">Try a different search or register as a donor</p>
                  </div>
                )}
              </StaggerChildren>
            )}
        ...
        {tab === 'requests' && (
          <div className="space-y-5">
            ...
            {showRequest && (
              <form onSubmit={handleCreateRequest} className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 p-6">
                <h3 className="text-lg font-semibold text-gray-800 dark:text-gray-100 mb-4 flex items-center gap-2">
            ...
            <StaggerChildren staggerDelay={100} className="space-y-4">
              {requests.map((r) => {
                ...
                return (
                  <div key={r.request_id} className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 p-6 hover:shadow-md active:scale-[0.99] transition-all duration-300">
                      ...
                      <div className="flex items-start gap-4">
                        ...
                        <div>
                          <div className="flex items-center gap-2 mb-1">
                            <span className="font-semibold text-gray-800 dark:text-gray-100">{r.blood_group}</span>
                            ...
                            <span className="text-sm text-gray-500 dark:text-gray-400">{r.units_needed} unit(s)</span>
                          </div>
                          {r.hospital_name && (
                          ...
                          {r.notes && <p className="text-sm text-gray-400 dark:text-gray-500 mt-1">{r.notes}</p>}
                        </div>
                      </div>
              ...
              {requests.length === 0 && (
                <div className="text-center py-12 bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700">
                  ...
                  <p className="text-gray-500 dark:text-gray-400 font-medium">No blood request yet</p>
                  <p className="text-gray-400 dark:text-gray-500 text-sm mt-1">Blood requests will appear here</p>
                </div>
              )}
            </StaggerChildren>
          </div>
